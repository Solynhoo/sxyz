...
**:icon{name="mdi:hand-wave-outline"}** Seja bem-vindo ao meu website! Me chamo **Solyn**, tenho 13 anos e faço :icon{name="mdi:hand-wave-outline"} *aniversário* dia **13/03**! Vivo em :icon{name="i-game-icons-portugal"} **Portugal**, no distrito de Setubal


## 🌿 Interesses
Nesta secção eu irei falar de alguns dos meus interesses *(que são varios)*

Eu gosto de muitas coisas, geralmente fico escutando **música** e assistindo **series** para me animar e para me divertir gosto de conversar com meus amigos!
...
#### :icon{name="simple-icons:crunchyroll"} Animes
...
Gosto tambem de programação, estou atualmente estudando
